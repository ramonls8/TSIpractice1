...
public class AgenteRTAStar extends AbstractPlayer{
	...
	public ACTIONS act(StateObservation stateObs, ElapsedCpuTimer elapsedTimer) {
		// Calculate the next movement and save the accumulated time it takes
	...
	private ACTIONS calculateNextMovement(StateObservation stateObs){
		...
		// heuristic of the second child
		nodes.put(currentNode, Math.max(currentNode.heuristic, secondChild.cost + secondChild.heuristic));
